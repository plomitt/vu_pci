...
site_small_image_path = "images/bubble-small-miku.png" # Represents a smaller aggregation zone
site_large_image_path = "images/bubble-full-miku.png" # Represents a larger aggregation zone
