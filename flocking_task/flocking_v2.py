...
import pygame as pg # Import pygame for collision detection
...
(
    ...
    # or implement image scaling when the obstacle is spawned. The current code assumes
    # a suitable image is provided.
    .spawn_obstacle("images/bubble-small.png", x=300, y=300) 
    .spawn_obstacle("images/bubble-small.png", x=700, y=200) 
    .spawn_obstacle("images/bubble-small.png", x=500, y=500) 
    .run()
)